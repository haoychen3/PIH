...
#
#     new_parser.add_argument('--not_cuda', action='store_true', help='disables cuda', default=0)
#     new_parser.add_argument('--manualSeed', type=int, help='manual seed')
#
#     new_parser.add_argument('--nc_im', type=int, help='image # channels', default=3)
#     new_parser.add_argument('--noise_amp', type=float, help='additive noise cont weight', default=0.1)
#     new_parser.add_argument('--min_size', type=int, help='image minimal size at the coarser scale', default=25)
#     new_parser.add_argument('--max_size', type=int, help='image minimal size at the coarser scale', default=250)
#
...
#
#     new_parser.add_argument('--input_name', help='input image name for training', default="./Images/Generation/tree.jpg")
#
#     return new_parser
