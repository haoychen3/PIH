...
def train(opt, opt_2, new_opt):
    ...
    for scale_num in range(opt.stop_scale+1):
        ...
        fixed_noise, fixed_noise_2, noise_amp, noise_amp_2, generator, d_curr = train_single_scale(d_curr, generator, reals, fixed_noise, fixed_noise_2, noise_amp, noise_amp_2, opt, scale_num, writer)
...
def train_single_scale(netD, netG, reals, fixed_noise, fixed_noise_2, noise_amp, noise_amp_2, opt, depth, writer):
    ...
    fixed_noise_2.append(z_opt_2.detach())
    ...
    if depth == 0:
        noise_amp.append(1)
        noise_amp_2.append(1)
    else:
        noise_amp.append(0)
        noise_amp_2.append(0)

        z_reconstruction = netG(fixed_noise, reals_shapes, noise_amp)
        z_reconstruction_2 = netG(fixed_noise_2, reals_shapes, noise_amp_2)
    ...
    for iter in _iter:
        ...
        if alpha != 0:
            ...
            rec_2 = netG(fixed_noise_2, reals_shapes, noise_amp_2)
        ...
        netG.zero_grad()
        errG_total = errG + rec_loss + rec_loss_2
        errG_total.backward()
    ...
    return fixed_noise, fixed_noise_2, noise_amp, noise_amp_2, netG, netD
