...
2. Training twenty models using twenty secret-cover image pairs, run: python train_multiple_models.py
...
### Original SinGAN without Hiding Image
1. To train original SinGAN without hiding any secret image, run: python ./NotHidingImage/train_original.py
